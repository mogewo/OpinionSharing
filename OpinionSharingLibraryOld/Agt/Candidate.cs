...
namespace OpinionSharing.Agt
{
    public class Candidate
    {
        ...
        public double ImportanceLevel { get { return importanceLevel; }}
        public double AwarenessRate { get { return awarenessRate; } }


        //新しい意見形成を得て、推定し直す
        public double EstimateAwarenessRate(bool determined)
        {
//            Console.Write("estimate awareness rate to {0}",ImportanceLevel);
            ...
            //Console.WriteLine(" -> " + awarenessRate);
            return awarenessRate;
        }
